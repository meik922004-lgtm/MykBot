    ...
    async def send_dm_warning(self, user_id: str, boss_tier: int):
        ...
        try:
            ...
            if user:
                ...
                embed = discord.Embed(
                    title="⚠️ WARNING FROM THE WORLD BOSS!",
                    description=f"Boss (Tier {boss_tier}) It's accumulating energy! In the next turn, it will use its skill to steal your **{skill_pct}% Max HP** .\n\n🛡️ **Use the Protect command immediately to survive.!**",
